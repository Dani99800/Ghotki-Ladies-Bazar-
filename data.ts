...
// DEDICATED PORTAL MOCK PRODUCTS
const RENTAL_PRODUCTS: Product[] = [
  {
    id: 'rent_1',
    shopId: 's1',
    name: 'Prime Commercial Shop for Rent - Ghotki Main Bazar',
    description: '250 Sq Ft ground floor shop in busy market area. Suitable for clothing, mobile or pharmacy. Includes glass front and shutter.',
    price: 35000,
    category: 'Rentals & Leases',
    subcategory: 'Shops for Rent',
    images: ['https://images.unsplash.com/photo-1582037928769-181f2644ecb7?auto=format&fit=crop&q=80&w=600'],
    tags: ['Hot Rental', 'Ground Floor'],
    stock: 1,
    location_city: 'Ghotki',
    status: 'APPROVED',
    portal_type: 'RENTAL',
  ...
  },
  {
    id: 'rent_2',
    shopId: 'sukkur_s_6_1',
    name: '3-Bed Luxury Family House for Rent - Sukkur Airport Road',
    description: 'Spacious 3 bedrooms with attached baths, modern kitchen, car parking and 24/7 security. Prime location near Airport Road.',
    price: 55000,
    category: 'Rentals & Leases',
    subcategory: 'Houses & Flats for Rent',
    images: ['https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&q=80&w=600'],
    tags: ['Family House', 'Verified Landlord'],
    stock: 1,
    location_city: 'Sukkur',
    status: 'APPROVED',
    portal_type: 'RENTAL',
  ...
  {
    id: 'rent_3',
    shopId: 'sukkur_s_10_3',
    name: 'Toyota Prado VIP SUV Rental with Driver',
    description: 'Toyota Prado available for wedding events, official tours and family trips across Sindh. Daily rate includes experienced driver.',
    price: 18000,
    category: 'Rentals & Leases',
    subcategory: 'Vehicles for Rent',
    images: ['https://images.unsplash.com/photo-1549399542-7e3f8b79c341?auto=format&fit=crop&q=80&w=600'],
    tags: ['VIP Rental', 'With Driver'],
    stock: 3,
    location_city: 'Sukkur',
    status: 'APPROVED',
    portal_type: 'RENTAL',
    ...
    vehicle_make: 'Toyota',
    vehicle_model: 'Prado TX',
    whatsapp: '923001234567'
  },
  {
    id: 'rent_4',
    shopId: 'sukkur_s_10_1',
    name: 'Complete Wedding Event Sound & Lighting Setup Rental',
    description: 'High power DJ speakers, stage lighting, wireless mics and generator backup for weddings and corporate events in Ghotki & Sukkur.',
    price: 25000,
    category: 'Rentals & Leases',
    subcategory: 'Event Gear for Rent',
    images: ['https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&q=80&w=600'],
    tags: ['Full Event Package'],
    stock: 5,
    location_city: 'Ghotki',
    status: 'APPROVED',
    portal_type: 'RENTAL',
...
const PROPERTY_PORTAL_PRODUCTS: Product[] = [
  {
    id: 'prop_1',
    shopId: 'sukkur_s_6_1',
    name: '120 Sq Yd Modern Double Story House for Sale - Ghotki',
    description: 'Brand new 4 bedrooms, 4 baths, marble flooring, car porch, automated gate and roof terrace. Ready to move.',
    price: 12500000,
    category: 'Property & Real Estate',
    subcategory: 'Houses for Sale',
    images: ['https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&q=80&w=600'],
    tags: ['Brand New', 'Clear Title'],
    stock: 1,
    location_city: 'Ghotki',
    status: 'APPROVED',
  ...
  },
  {
    id: 'prop_2',
    shopId: 'sukkur_s_6_2',
    name: 'Prime Corner Commercial Plot 200 Sq Yd - Sukkur Township',
    description: 'Commercial plot on 60ft main boulevard. High commercial value, ideal for plaza, hospital or showroom.',
    price: 4800000,
    category: 'Property & Real Estate',
    subcategory: 'Plots',
    images: ['https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&q=80&w=600'],
    tags: ['Commercial Corner', 'Main Boulevard'],
    stock: 1,
    location_city: 'Sukkur',
    status: 'APPROVED',
    portal_type: 'PROPERTY',
  ...
  },
  {
    id: 'prop_3',
    shopId: 'sukkur_s_6_5',
    name: '15 Acres Fertile Agricultural Land - Near Indus River Sukkur',
    description: 'Highly fertile land with tube-well, solar power setup and canal water access. Perfect for cotton, wheat and sugarcane crops.',
    price: 28000000,
    category: 'Property & Real Estate',
    subcategory: 'Agricultural Land',
    images: ['https://images.unsplash.com/photo-1500595046743-cd271d694d30?auto=format&fit=crop&q=80&w=600'],
    tags: ['Solar Tubewell', 'Canal Water'],
    stock: 1,
    location_city: 'Sukkur',
    status: 'APPROVED',
    portal_type: 'PROPERTY',
  ...
  },
  {
    id: 'prop_4',
    shopId: 'sukkur_s_6_3',
    name: 'Running Commercial Shop for Sale - Resham Gali Ghotki',
    description: 'Fully furnished shop in heart of Resham Gali market. High footfall daily. Great return on investment.',
    price: 8500000,
    category: 'Property & Real Estate',
    subcategory: 'Shops for Sale',
    images: ['https://images.unsplash.com/photo-1582037928769-181f2644ecb7?auto=format&fit=crop&q=80&w=600'],
    tags: ['High Footfall', 'Prime Market'],
    stock: 1,
    location_city: 'Ghotki',
    status: 'APPROVED',
    portal_type: 'PROPERTY',
...
const MOTORS_PORTAL_PRODUCTS: Product[] = [
  {
    id: 'motor_1',
    shopId: 'sukkur_s_1_1',
    name: 'Toyota Corolla GLi 1.3 Automatic 2021 Mint Condition',
    description: 'First owner car, 45,000 KM driven. Bumper to bumper original paint, new tyres, Android panel installed. Sukkur registered.',
    price: 3850000,
    category: 'Cars & Vehicles',
    subcategory: 'Cars',
    images: ['https://images.unsplash.com/photo-1549399542-7e3f8b79c341?auto=format&fit=crop&q=80&w=600'],
    tags: ['Bumper to Bumper', 'First Owner'],
    stock: 1,
    location_city: 'Sukkur',
    status: 'APPROVED',
    portal_type: 'MOTOR',
  ...
  },
  {
    id: 'motor_2',
    shopId: 'sukkur_s_1_2',
    name: 'Suzuki Alto VXR Manual 2023 White Color',
    description: '18,000 KM driven, full company service history, spotless interior and immaculate fuel average (22 KM/L).',
    price: 2750000,
    category: 'Cars & Vehicles',
    subcategory: 'Cars',
    images: ['https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?auto=format&fit=crop&q=80&w=600'],
  ...
  },
  {
    id: 'motor_3',
    shopId: 'sukkur_s_1_4',
    name: 'Honda CD 70 2024 Red Model - Unregistered',
    description: 'Brand new Honda CD 70 2024 model. Zero meter condition, company invoice available for immediate registration.',
    price: 158000,
    category: 'Cars & Vehicles',
    subcategory: 'Motorcycles',
    images: ['https://images.unsplash.com/photo-1558981806-ec527fa84c39?auto=format&fit=crop&q=80&w=600'],
    tags: ['Zero Meter', '2024 Model'],
    stock: 10,
    location_city: 'Ghotki',
    status: 'APPROVED',
    portal_type: 'MOTOR',
  ...
  },
  {
    id: 'motor_4',
    shopId: 'sukkur_s_1_5',
    name: 'Yamaha YBR 125G Metallic Black Edition 2023',
    description: '6,500 KM driven carefully. Smooth ride, disk brake, alloy wheels and dry battery installed.',
    price: 380000,
    category: 'Cars & Vehicles',
    subcategory: 'Motorcycles',
    images: ['https://images.unsplash.com/photo-1558981806-ec527fa84c39?auto=format&fit=crop&q=80&w=600'],
    tags: ['Disk Brake', 'Self Start'],
    stock: 1,
    location_city: 'Sukkur',
    status: 'APPROVED',
    portal_type: 'MOTOR',
    vehicle_make: 'Yamaha',
    vehicle_model: 'YBR 125G',
    vehicle_year: 2023,
    mileage_km: 6500,
    fuel_type: 'Petrol',
    transmission: 'Manual',
...
export const MOCK_PRODUCTS: Product[] = [
  ...BASE_PRODUCTS, 
  ...GENERATED_SUKKUR_PRODUCTS,
  ...RENTAL_PRODUCTS,
  ...PROPERTY_PORTAL_PRODUCTS,
  ...MOTORS_PORTAL_PRODUCTS
];
