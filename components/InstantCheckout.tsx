       ...
       <div className="bg-white w-full max-w-lg rounded-t-[3rem] p-8 space-y-6 animate-in slide-in-from-bottom-full duration-500 shadow-2xl relative max-h-[90vh] overflow-y-auto">
          {step === 'FORM' ? (
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="flex items-center justify-between">
                 <div>
                   ...
                   <p className="text-[10px] font-black text-pink-600 uppercase tracking-widest">Guest Checkout Available</p>
                 </div>
              ...
              <div className="p-6 bg-gray-900 rounded-3xl text-white flex justify-between items-center shadow-xl">
                 <div>
                   ...
                   <span className="text-xs text-white/40 italic">Incl. 150 Delivery</span>
                 </div>
            ...
            <div className="py-20 text-center space-y-4">
               ...
               <h2 className="text-3xl font-black uppercase italic tracking-tighter text-gray-900">Order Placed!</h2>
               <p className="text-gray-400 text-xs font-bold uppercase px-6">The shopkeeper has received your request. They will call you on <span className="text-gray-900 font-black">{formData.mobile}</span> shortly.</p>
               <button onClick={onClose} className="mt-8 text-pink-600 font-black uppercase text-[10px] tracking-[0.3em]">Keep Browsing</button>
            </div>
          )}
       </div>
    </div>
